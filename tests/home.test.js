...
//   ./run.sh tests/home.test.js               # all 6 cases (TC-01 -> TC-06)
//   ./run.sh -e TC=TC-01 tests/home.test.js   # only VU 50
//   ./run.sh -e TC=300   tests/home.test.js   # only VU 300 (by VU count)

import { thresholds } from '../lib/config.js';
import { ENDPOINTS } from '../lib/endpoints.js';
import { makeSetup, runGets } from '../lib/runner.js';

// All six cases. startTime sequences them back-to-back (30s each).
const ALL_CASES = {
...
// -e TC=TC-01 (or TC01, or 50) runs a single case at t=0; otherwise run all six.
...
const EP = ENDPOINTS.public;
export const setup = makeSetup(null, EP); // public: no login
