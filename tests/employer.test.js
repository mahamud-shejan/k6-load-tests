// EMPLOYER — GET /employer/dashboard
...
//   ./run.sh tests/employer.test.js               # all 6 cases
//   ./run.sh -e TC=TC-01 tests/employer.test.js   # only VU 50
//   ./run.sh -e TC=300   tests/employer.test.js   # only VU 300 (by VU count)
...
const EP = ENDPOINTS.employer;
export const setup = makeSetup('employer', EP);
