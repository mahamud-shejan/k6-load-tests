// OPS — GET /ops/dashboard (+ /ops/supply-pool)
...
//   ./run.sh tests/ops.test.js               # all 6 cases (TC-01 -> TC-06)
//   ./run.sh -e TC=TC-01 tests/ops.test.js   # only VU 50
//   ./run.sh -e TC=300   tests/ops.test.js   # only VU 300 (by VU count)
...
const EP = ENDPOINTS.ops;
export const setup = makeSetup('ops', EP);
